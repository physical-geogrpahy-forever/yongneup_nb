...
("    return npp,aet,lai,htrait,all_yr,cleaf",
 "    return npp,aet,lai,htrait,all_yr,cleaf,latent_h,latent_all,latent_cleaf,agb_c,raw_npp,woody_productive,optimizer_pathological,maladapted_frozen"),
("    npp,aet,lai,htrait,all_yr,cleaf=assemble(summary,monthly,z.shape)",
 "    npp,aet,lai,htrait,all_yr,cleaf,latent_h,latent_all,latent_cleaf,agb_c,raw_npp,woody_productive,optimizer_pathological,maladapted_frozen=assemble(summary,monthly,z.shape)"),
...
("'EEMT_MJ_m2_yr':eemt[rr,cc],'LAI':lai[rr,cc]",
 "'EEMT_MJ_m2_yr':eemt[rr,cc],'raw_NPP_gC_m2_yr':raw_npp[rr,cc],'woody_productive':bool(woody_productive[rr,cc]),'optimizer_pathological':bool(optimizer_pathological[rr,cc]),'maladapted_frozen':bool(maladapted_frozen[rr,cc]),'latent_H_m':latent_h[rr,cc],'latent_a_ll_yr':latent_all[rr,cc],'latent_C_leaf_gC_individual':latent_cleaf[rr,cc],'AGB_C_g_m2_component_sum':agb_c[rr,cc],'Pelletier_AGB_dry_kg_m2':agb[rr,cc],'LAI':lai[rr,cc]")
]
